...
- [x] 6.1 `notebooks/waveform.ipynb`: overlay image + spatial/temporal plots + `IPython.display.Audio`
- [x] 6.2 Auto-runs the pipeline if data files are missing (self-contained)
- **Validation:** `nbconvert --execute` exits 0; automated nbclient test in pytest. ✅
